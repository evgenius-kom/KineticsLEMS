...
| Vyazovkin AIC (2001)           | nonlinear integral, numerical  | E_a(α), arbitrary T(t) |
...
Rates:    [2.5, 5.0, 10.0, 20.0] K/min
  friedman       mean E_a =  119.98 kJ/mol
  kas            mean E_a =  119.74 kJ/mol
  ofw            mean E_a =  121.84 kJ/mol
  vyazovkin      mean E_a =  120.01 kJ/mol
  vyazovkin_aic  mean E_a =  119.98 kJ/mol
  kissinger      E_a =  120.29 kJ/mol (R²=1.0000)
```
...
docs/ALGORITHMS.md          # math reference for every method
tests/                      # pytest suite
examples/synthetic/         # ready-to-analyze synthetic cases
```
